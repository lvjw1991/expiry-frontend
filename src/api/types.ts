...
export interface ReceivingOrderItem { id: number; supplierCode?: string; productName?: string; barcode?: string; orderQty?: number; actualQty?: number; total?: number; expiryDate?: string; unitPrice?: number; category?: string; sugar?: string; checkStatus?: 'UNCHECKED'|'PASS'|'FAIL'|string }
