...
export function processExpiryRecord(id:number,processStatus:'NORMAL'|'PROMOTE'|'DAMAGE',processRemark?:string){return http.post<boolean>(`/records/${id}/process`,{id,processStatus,processRemark})}
